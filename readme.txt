...
- Add a new button on forms edition to add AcyMailing lists
...
2. Search for `Contact Form 7 AcyMailing`
...
You can find the complete documentation here: https://docs.acymailing.com/addons/wordpress-add-ons/contact-form-7
